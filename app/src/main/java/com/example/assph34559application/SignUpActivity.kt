...
import com.example.assph34559application.customcompose.TitleCompose
...
class SignUpActivity : ComponentActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContent {
            GetLayoutSignUp(NavHostController(LocalContext.current))
...
@Composable
fun GetLayoutSignUp(navController: NavHostController) {
